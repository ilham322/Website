...
import axios from 'axios'; // Pastikan mengimpor axios jika menggunakan axios untuk HTTP request

const snap = new midtransClient.Snap({
  isProduction: false, // Pastikan ini false untuk mode sandbox
  serverKey: "SB-Mid-server-f8AwxImKyxuupzuKrYGycQLU", // Ganti dengan server key 
  clientKey: "SB-Mid-client-1RMpcVBKaS7Xr4U5", // Ganti dengan client key 
});
...
const placeOrder = async (req, res) => {
  ...
  try {
    ...
    // Memastikan menggunakan Server Key yang benar (gunakan Server Key )
